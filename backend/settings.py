...
SECRET_KEY = "django-insecure-cf_&aftd5x&ev3c#xmv+acdzdt_tp=8e=8blflbwz^z!u+y6c="
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # Thêm vào đầu tiên
